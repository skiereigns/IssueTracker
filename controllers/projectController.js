...
const homePage = asyncHandler( async (req,res)=>{
    ...
    res.render('homePage',{title:"Issue Tracker",allProjects})
})

// Create Project page
const createProjectPage = asyncHandler( async (req,res)=>{
    res.render('createProject',{title:"Create Project - Issue Tracker "})
})
...
const projectDetails = asyncHandler( async (req,res)=>{
    ...
    res.render('projectDetails',{title:"Details - Issue Tracker",project})
})

// Create Issue Page
const createIssuePage = asyncHandler( async (req,res)=>{
    const project = await ProjectModel.findById(req.params.id)
    res.render('createIssue',{title:"Create Issue - Issue Tracker", project})
})
